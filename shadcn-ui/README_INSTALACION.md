...
- Dominio configurado en Cloudflare: `sas.rdktech.us`
...
### Primer Acceso:
1. Abrir navegador en: `http://sas.rdktech.us` o `http://localhost:7771`
...
2. Verificar que los puertos 7771 y 3001 están disponibles
